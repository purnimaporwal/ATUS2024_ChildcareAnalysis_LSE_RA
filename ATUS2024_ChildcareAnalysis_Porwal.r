...
m1_direct_care_labels <- c(
  ...
  "7"  = "Organization and planning (retired code — not present in 2024)",
  "8"  = "Organization and planning for household children",
...
# Overwrite non-household row labels to match the ATUS Lexicon architecture perfectly
m1_direct_care$Activity[m1_direct_care$Code == "040108"] <- "Organization and planning for non-HH children"
m1_direct_care$Activity[m1_direct_care$Code == "040110"] <- "Attending non-HH children's events"
