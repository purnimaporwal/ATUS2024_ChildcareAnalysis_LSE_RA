...
getwd() # set the working directory to the folder where the data is stored
...
sapply(resp[, c("TUFINLWGT", "TELFS", "TRCHILDNUM", "TRTCCC", "TUDIARYDAY")], class)
sapply(rost, class)
...
dim(atus_merged)    # should be 139,535 rows (one per activity
...
#  06=talking, 07=homework, 08=events, 10=medical, 99=other)
...
m1_direct_care_labels <- c(
  ...
  "8"  = "Attending children's events",
  "10" = "Obtaining medical care for children",
